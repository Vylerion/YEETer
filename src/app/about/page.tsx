  ...
  return (
    <PageLayout title="About Us">
      <div className="space-y-4 text-center md:text-left">
        <p>
          Welcome to AgriMenu, your digital gateway to modern farming solutions. We were founded on the principle that technology can revolutionize agriculture, making it more efficient, sustainable, and profitable for farmers everywhere.
        </p>
